...
class DocumentBuilder {
    private const TIPI_SUPPORTATI = [
        ...
        // ASR 2025 Compliance Engine
        'AUDIT_REPORT_ASR2025','PIANO_FORMATIVO_ASR2025','SCADENZIARIO_ASR2025',
        'LETTERA_INCARICO_RSPP','NOMINA_PREPOSTO','NOMINA_ADDETTI_EMERGENZA',
        'REGISTRO_FORMAZIONE','REGISTRO_ATTESTATI',
    ];
