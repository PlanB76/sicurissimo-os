...
// Mostra disponibili, posseduti, elite space e una CTA verso pix81.html.
(function(){
  function css(){
  ...
  async function render(el){
    ...
    el.innerHTML=`
      ...
      <a class="cta" href="pix81.html">${st.elite_space?'Aggiungi un PIX':'Sblocca il tuo Elite Space'}</a>`;
  }
