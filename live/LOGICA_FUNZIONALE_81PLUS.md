...
81X (token BSC BEP-20): il token dell'ecosistema con uso interno ed esterno, ma solo on-chain. Supply totale 21 milioni, di cui 5 milioni genesi per airdrop e offerte private a 0,10 USDT. Burn 0,5% per trasferimento, halving ogni 4 anni. Solo DEX, nessun DEX. L'81X si compra e vende solo sui pool on-chain (PancakeSwap o pool proprietario 81plus.exchange).
...
Nessun DEX. L'utente mantiene sempre il controllo delle sue chiavi. MetaMask bind sul wallet crypto del SIC-ID. Nessuna custodia dei fondi da parte dell'ecosistema.
